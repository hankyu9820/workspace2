...
<body>
	...
	-> 복수 파라미터에 사용하는 경우 맨 앞(0번째 인덱스) 값만 얻어온다. <br><br>
	
	${ param.lang }
	
	<br><br>
	
	2. \${ paramValues.lang[인덱스번호] } <br><br>
	...
	<ul>
		String[] lang;
		for(String str : lang)
		<c:forEach var="str" items="${paramValues.lang }" varStatus="vs"> <!-- 현재 반복에 해당하는 정보 -->
			<li>
				${str} / ${vs.index} / ${vs.count} / ${vs.current} <br>
				
				<c:if test="${ vs.first }"> <!-- 첫 번째 반복인 경우 -->
