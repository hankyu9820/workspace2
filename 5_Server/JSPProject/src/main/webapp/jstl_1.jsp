...
<body>
	...
	<pre>
		- 변수를 선언하고 값을 초기화하는 태그(초기화는 무조건 수행한다.)
	...
	<!-- <태그명 /> : 태그가 시작 되자마자 종료한다. => 내용이 없는 요소다. -->
	
	<c:set var="num" value="100" /> <!-- pagescope  -->
	...
	<pre>
		...
		- if문만 가능하고 else는 불가능하다. (c:else 존재하지 않음)
