            ...
            <section class="myPage-main">
                ...
                <!-- 
                    ...
                    2) multipart/form-data : 제출할 때 인코딩을 하지 않음
                        -> 모든 데이터가 원본 형태를 유지한다.(파일이 파일 상태로 서버로 제출) -- 파일 자체를 제출
                            (주의) multipart/form-data로 설정 시 method는 무조건 POST 방식이어야 한다.
                 -->
                 ...
                 <div class="profile-image-area">
                    ...
                    <div class="profile-btn-area">
                        ...
                        <input type="file" name="profileImage" id="input-image" accept="image/*"> <!-- 파일태그 꾸미기가 불가능임 -->
