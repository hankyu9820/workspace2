...
public class MyPageController {
	...
	public String secession(@SessionAttribute("loginMember") Member loginMember, String memberPw
							, SessionStatus status
							, RedirectAttributes ra
							, HttpServletResponse resp) {
		// SessionStatus : 세션을 관리하는 객체
		// RedirectAttributes : 리다이렉트 시 request로 값 전달하는 객체
	...
	// 프로필 이미지 수정
	@PostMapping("/profile") // responseBody, requestBody -> ajax
