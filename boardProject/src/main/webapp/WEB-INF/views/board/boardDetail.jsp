        ...
        <section class="board-detail">  
            ...
            <div class="board-header">
                ...
                <div class="board-info">
                    <p> <span>${board.boardCreateDate}</span> 2023년 05월 09일 10:33:21 </p>     

                    <!-- 수정한 게시글인 경우 -->
                    <c:if test="${!empty board.boardUpdateDate}" >
                        <p> <span>${board.boardUpdateDate}</span>   2023년 05월 09일 11:48:50 </p>   
                    </c:if>
